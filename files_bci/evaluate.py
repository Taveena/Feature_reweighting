...
window=1000
n_channels=22
model_name = 'mieegnet'   # EEGNet, EEGNet_fusion, MI_EEGNet, DeepConvNet_orig, shallowconvnet_repeated, TS_SEFFNet, temporal_gated_final, channel_gated_final, fgnet, fgnet_msfnot
...
for j in range(1,10):
	...
	for i in range(1,6):
		model_path='weights_5fold/'+model_name+'/'+str(j)+'/'+str(i)+'/'
		data_path='./split_bci_5fold/A0'+str(j)+'/'+str(i)+'_test.txt'
