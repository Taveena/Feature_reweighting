...
from eeg_deepconvnet import DeepConvNet
from eeg_model import MI_EEGNet
from eeg_fgnet_msfnot import *
from eeg_fgnet import *
#from eeg_fgnet_v1 import *
...
parser.add_argument('--log_file', type=str, default='log_files_bci_5fold', 
...
if model_name=='shallow':
	net = ShallowConvNet(n_classes=n_classes,input_shape=[batch_size,1,channel,window], F1=40, T1=25, F2=40, P1_T=75, P1_S=15, drop_out=0.5,last_dim=2440).cuda()
elif model_name=='deep':
	net = DeepConvNet(n_classes=n_classes,input_shape=[batch_size,1,n_channels,window],first_conv_length=10,block_out_channels=[25, 25, 50, 100, 200],pool_size=3,last_dim=1800).cuda()
...
criterion = nn.CrossEntropyLoss() #torch.nn.functional.nll_loss# torch.nn.functional.nll_loss
