...
if model_name=='shallow':
	net = ShallowFBCSPNet(n_chans, n_classes, input_window_samples=None, final_conv_length=30, ).cuda() # no need to provide input_window_samples if final_conv_length given
elif model_name=='fgnet_v1':
