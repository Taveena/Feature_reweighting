...
if model_name=='fgnet':
	...
	n_channels=channel
	net = DeepConvNet(n_classes=n_classes,input_shape=[batch_size,1,n_channels,window],first_conv_length=10,block_out_channels=[25, 25, 50, 100, 200], pool_size=2, last_dim=4600).cuda()
	net.weights_init()
