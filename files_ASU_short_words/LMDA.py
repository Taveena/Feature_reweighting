...
class LMDA(nn.Module):
    ...
    def __init__(self, chans=22, samples=1125, num_classes=4, depth=9, kernel=75, channel_depth1=24, channel_depth2=9,
        ...
        #nn.init.xavier_uniform_(self.channel_weight.data)   # un-comment for training and comment for testing
...
if __name__ == '__main__':
     net = LMDA(num_classes= 3, chans=60, samples=512, channel_depth1=24, channel_depth2=7).cuda()
     input=torch.randn(5,1,60,512).cuda()
     output = net(input)
     from torchinfo import summary
     summary(net.cuda(), (5, 1,60, 512))
