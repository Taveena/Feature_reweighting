...
class custom_dataset(data.Dataset):
	...
	def load_data(self, instance, type='txt'):
	...
	def __getitem__(self, index):
		...
		signal, label = self.load_data(instance, type='mat')
		signal = signal.astype('float32')
		#print('before shape', signal.shape)
		#signal = signal.unsqueeze(1)
		#print('after shape', signal.shape)
		signal = self.preprocessing_persample(signal)
		#signal = self.random_sample(signal)
		#signal = signal[:,500:500+80]
		if self.viz:
