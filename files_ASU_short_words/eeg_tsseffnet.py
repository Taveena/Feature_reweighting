...
class TS_SEFFNet(nn.Module):
    ...
    def __init__(self,in_chans=22,
        ...
        self.reshape1 = nn.AdaptiveAvgPool2d((1, 31))    ##################### changed for ASU dataset from 61 to 31
        ...
        #the Classifier
        self.conv_classifier=nn.Conv2d(100,self.n_classes,(2, 1),bias=True)
...
if __name__ == "__main__":
     ...
     net=TS_SEFFNet(in_chans=22, n_classes=4).cuda()
     input=torch.randn(1,22,1000,1).cuda()
     from torchinfo import summary
     summary(net.cuda(), (1,22,1000,1))
