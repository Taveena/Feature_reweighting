...
class SpatialSELayer(nn.Module):
    ...
    def __init__(self, num_channels, Samples, reduction_ratio=2):
        ...
        self.avg_pool_block1 = nn.AdaptiveAvgPool2d((1,Samples//4)) 
        self.upsample1 = nn.Upsample(scale_factor = (1,2), mode = 'nearest')
        self.avg_pool_block2 = nn.AdaptiveAvgPool2d((1,Samples//8))
        self.upsample2 = nn.Upsample(scale_factor = (1,4), mode = 'nearest')
        self.avg_pool_block3 = nn.AdaptiveAvgPool2d((1,Samples//16)) 
        self.upsample3 = nn.Upsample(scale_factor = (1,8), mode = 'nearest')
    ...
    def forward(self, input_tensor, weights=None):
        ...
        #print('upsample1', block1.shape, 'upsample2', block2.shape,'upsample3', block3.shape, 'conv_out', conv_out.shape)
...
if __name__=='__main__':
     ...
     net=EEGNet_fgnet(1, Chans=22, Samples=1000).cuda()
     ...
     with profile(activities=[ProfilerActivity.CPU], record_shapes=True) as prof:
         with record_function("inferential_process"):
             net(input)
