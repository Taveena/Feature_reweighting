...
do
	...
	do
		...
		python train_mieegnet.py --no_epochs $NO_EPOCHS --n_classes $N_CLASSES --batch_size $BATCH_SIZE --window $WINDOW --channel $CHANNEL --train_list $TRAIN_LIST --test_list $TEST_LIST --val_list $VAL_LIST --model_name $MODEL_NAME --patience $PATIENCE
